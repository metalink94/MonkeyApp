package ru.monkeys.monkeyapp.screens.game.tictactoe;
...
public class PlayGameWithComputer extends BaseActivity {
    int turn = 1;
    int win = 0;
    int gamov = 0;
    int flagEndGame = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player1Name = sharedPreferences.getString(NICKNAME, "player");
